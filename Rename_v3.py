...
helppath = 'E:\\auto_Project\\gerenzhushou\\help_documentation'
uppath = 'E:\\auto_Project\\gerenzhushou\\upgrade_package'
...
for file in os.listdir('./'):
    if os.path.isdir(os.path.join(path, file)) and re.match(r'^pkg-linux-arm64.*', file):
        ...
        shutil.copy(os.path.join(path, file, "灵犀·晓伴.zip"), os.path.join(uppath, new2_linux_arm64))
    ...
    if os.path.isdir(os.path.join(path, file)) and re.match(r'^pkg-linux-x64.*', file):
        ...
        # 复制文件"灵犀·晓伴.zip"文件到uppath文件夹下
        shutil.copy(os.path.join(path, file, "灵犀·晓伴.zip"), os.path.join(uppath, new2_linux_x64))
    ...
    if os.path.isdir(os.path.join(path, file)) and re.match(r'^pkg-mac-arm64.*', file):
        ...
        # 复制文件"灵犀·晓伴.zip"文件到uppath文件夹下
        shutil.copy(os.path.join(path, file, "灵犀·晓伴.zip"), os.path.join(uppath, new2_mac_arm64))
    ...
    if os.path.isdir(os.path.join(path, file)) and re.match(r'^pkg-mac-x64.*', file):
        ...
        # 复制文件"灵犀·晓伴.zip"文件到uppath文件夹下
        shutil.copy(os.path.join(path, file, "灵犀·晓伴.zip"), os.path.join(uppath, new2_mac_x64))
...
if get_suxiaoban_setup_files('./'):
    ...
    # 复制文件"灵犀·晓伴.zip"文件到uppath文件夹下
    shutil.copy(os.path.join(path, get_suxiaoban_setup_files('./')[0]), os.path.join(uppath, new2_win_x64))
